...
test_questions = [
    "How can I support my partner's healing from past relationship trauma while maintaining my own boundaries?",
    "What are some subtle ways to recognize emotional abuse early on?",
    "How do I navigate moments when my cultural background clashes with my partner's in subtle but impactful ways?"
...
def handle_message(data):
    ...
    user_msg =  "I'm dealing with the mental health impact of genetic testing results"
